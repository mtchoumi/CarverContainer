...
public class SEP_TextScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            menuText.text = "Press up when the reticle is above the bowl. Press up to start!";
        }
        if(SEP_MenuScript.stageNum == 3)
        {
            menuText.text = "Congratulations! You finished cooking the pasta!";
        }
    }
}
